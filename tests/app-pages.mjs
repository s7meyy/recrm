...
const routes = ['today','dashboard','opportunities','properties','map','clients','tours','requests','matches','external','pricing','invoices','expenses','publish','prospects','tasks','notes','health','settings'];
