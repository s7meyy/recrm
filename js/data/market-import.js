...
export const MARKET_SOURCES = [
  {
    ...
    hint: 'ملفّاتٌ تاريخيّةٌ تُنزَّل (CSV) ثم تُفلَت هنا، وترخيصُ البيانات المفتوحة يُجيز الاستعمال وإعادةَ النشر بالإسناد. **ولوحاتُ تفاصيل الصفقات لم تعد تُحدَّث هناك** منذ صارت البورصة العقاريّة هي مَعرِضَ الصفقات الحيّ — فما تجده اليوم أرشيفٌ يصلح للاتّجاه لا لسعر الأمس.',
    columns: {
  ...
  {
    /**
     * **المؤشّرُ الذي لم تسأل عنه وهو مجّانيٌّ ويعمل اليوم** (المرحلة ٥٢): مؤشّرُ
     * الإيجار العامّ من الهيئة — متوسّطاتُ الإيجار بالحيّ والنوع، **بلا اشتراكٍ ولا
     * تسجيلِ دخولٍ ولا نفاذ**. وهو أقربُ ما يُسند به تسعيرةَ إيجارٍ اليوم في المملكة.
     */
    key: 'rega_rent',
    label: 'مؤشّر الإيجار العامّ — الهيئة العامة للعقار',
    kind: 'open',
    site: 'https://rentalrei.rega.gov.sa/publicindicators',
    hint: 'صفحةٌ عامّةٌ تُفتح بلا حسابٍ ولا نفاذ: متوسّطاتُ الإيجار بالمدينة والحيّ ونوع الوحدة، من عقود «إيجار» الموثَّقة. تُقرأ مباشرةً، وما تنسخه منها جدولًا يُستورَد هنا غرضُه «إيجار».',
    columns: null,
  },
  {
    key: 'srem',
    ...
    hint: 'وهي اليوم **مَعرِضُ الصفقات الحيّ** بعد أن توقّف نشرُ تفاصيلها في بوّابة البيانات المفتوحة: تُعرض على موقعها بلا تسجيلِ دخول، **ولا واجهةَ برمجيّةً عامّةً موثّقةً لها** وسائرُ خدماتها خلف «نفاذ». فما يُستورَد منها ما تُصدّره صفحتُها أو ما تنسخه بيدك — والسحبُ الآليّ وعدٌ لا يُوفى.',
    columns: null,
  },
  {
    key: 'registry',
