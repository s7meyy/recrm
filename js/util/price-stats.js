 ...
 */
/**
 * **عبارةُ حدِّ المؤشّر** (المرحلة ٤٧) — تُقال في كلّ موضعٍ يُستشهد به فيه.
 *
 * كان الحدُّ مكتوبًا في صفحة «مؤشر سعر المتر» وحدها، وفي رأس هذا الملفّ. **والشارةُ التي
 * تقول «أعلى من وسيط الحي بـ١٢٪» تظهر في بطاقة كلّ عقار**، فتُقرأ حكمًا من السوق وهي
 * حكمٌ من محفظتك أنت: مخزونُك المعتمد، وما أدخلتَه من عروضٍ خارجية، وصفقاتُك المنجزة.
 *
 * وهذا ليس عيبًا فيه — بل هو أصدقُ ما يمكن بلا اشتراكٍ في مصدرِ بياناتٍ للسوق. **والعيبُ
 * أن يُقرأ على غير ما هو**، فيُقال ما هو في موضعه.
 */
export const INDEX_SCOPE_NOTE = 'وسيطٌ من بياناتك أنت لا من السوق كلِّه: مخزونُك المعتمد، والعروض الخارجية التي أدخلتَها، وصفقاتُك المنجزة.';
