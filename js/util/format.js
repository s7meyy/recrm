...
export const NOUNS = {
  ...
  لوحة: ['لوحةٌ واحدة', 'لوحتان', 'لوحات', 'لوحة'],
  قسم: ['قسمٌ واحد', 'قسمان', 'أقسام', 'قسمًا'],
  قالب: ['قالبٌ واحد', 'قالبان', 'قوالب', 'قالبًا'],
  فرصة: ['فرصةٌ واحدة', 'فرصتان', 'فرص', 'فرصة'],
  مرحلة: ['مرحلةٌ واحدة', 'مرحلتان', 'مراحل', 'مرحلة'],
  سطر: ['سطرٌ واحد', 'سطران', 'أسطر', 'سطرًا'],
  صفحة: ['صفحةٌ واحدة', 'صفحتان', 'صفحات', 'صفحة'],
  مرفق: ['مرفقٌ واحد', 'مرفقان', 'مرافق', 'مرفقًا'],
