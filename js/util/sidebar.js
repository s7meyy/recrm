...
export const SIDEBAR_PAGES = [
  ...
  { key: 'management', label: 'إدارة الأملاك', icon: '🔑' },
  { key: 'rega', label: 'العقود والتراخيص', icon: '📜' },
  { key: 'stamp', label: 'ختم الصور والمقاطع', icon: '🖼️' },
  { key: 'extract', label: 'تفريغ المستندات', icon: '📄' },
  { key: 'invoices', label: 'الفواتير وعروض الأسعار', icon: '🧾' },
  { key: 'deals', label: 'الصفقات', icon: '🤝' },
  { key: 'expenses', label: 'المالية', icon: '💸' },
  ...
  { key: 'trash', label: 'سلة المحذوفات', icon: '🗑️' },
