...
export const ROUTE_WORDS = [
  ...
  ['inbox', ['الوارد', 'صندوق الوارد', 'الرسايل الوارده', 'الرسائل الواردة']],
  ['market', ['السوق', 'سوق العقار', 'اسعار السوق', 'الصفقات الحقيقيه']],
  ...
  ['deals', ['الصفقات', 'صفقات', 'الصفقه', 'العمولات']],
  ['expenses', ['الماليه', 'المصاريف', 'الايرادات', 'الحسابات']],
  ['publish', ['الصفحه العامه', 'النشر']],
  ['facilities', ['اداره المرافق', 'إدارة المرافق', 'المرافق', 'مرافق']],
  ['prospects', ['الفرص العقاريه', 'الفرص العقارية', 'فرص عقاريه', 'فرص عقارية']],
  ['tasks', ['المهام', 'مهام']],
  ['calendar', ['التقويم', 'المواعيد']],
  ['notes', ['الافكار', 'الملاحظات']],
  ['health', ['صحه البيانات']],
  ['trash', ['سله المحذوفات', 'المحذوفات', 'السله', 'المحذوف']],
...
const NEW_WORDS = [
  ...
  ['deals', ['صفقه جديده', 'اضف صفقه', 'سجل صفقه']],
