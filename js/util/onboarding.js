...
export function startSteps({
  ...
  return [
    ...
    },
    {
      ...
      // **`#/tools` لم يكن مسارًا قطّ** (كُشف بتدقيق المرحلة ٥٤): «الأدوات» اسمُ مجموعةٍ
      // في القائمة لا اسمُ صفحة، فكان زرُّ أوّلِ خطوةٍ يُوصي بها النظامَ الجديدَ يهبط
      // على «مسارٌ غير معروف». والنسخةُ الاحتياطيّة في الإعدادات.
      href: '#/settings',
      cta: 'الإعدادات',
