...
`tests/design-dhad.mjs` — ٣٩ فحصًا في متصفح حقيقي، وأكثرها يقرأ من `getComputedStyle`
...
| `css/components.css` | مساحة اللمس والحالات التفاعلية لكل مكوّن؛ إصلاح لون الجدول الليلي و`.card-pick` و`.range`؛ نقل القواعد الميتة؛ لون المساعدة |
...
| `tests/design-dhad.mjs` | **جديد** — ٣٩ فحصًا للهوية والمقاييس واللمس والاتجاه والحالات والوضع الليلي |
...
- **`node tests/run.mjs` — ١٠٢٢ ناجح · ٠ فاشل** (٩٨٣ قديمة بلا تعديل + ٣٩ جديدة).
