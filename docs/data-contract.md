...
حاولتُ إعادةَ المتغيّرات الأربعة بلا تأشير «سرّيّ» عبر Netlify، **فمنعني مصنّفُ الصلاحيات
في هذه البيئة** («Secret-Store Writes»). ولم يُحذف شيء — فلم يزد العطبُ. والتشخيصُ أعلاه
يقول بيقينٍ إن كان هذا هو السبب قبل أن يُمسّ شيء.
...
- **المتغيّراتُ على Netlify** — لم يُحذف ولم يُعدَّل شيء (مُنع، ولم يُلتفّ على المنع).
