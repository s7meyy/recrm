...
export const STEPS = [
  ...
  { view: 'new', sel: '#btn-add-region', title: 'وما ليس في القوائم يُضاف',
    body: 'منطقة أو دولة، ومدينة، وتصنيف، وحيّ — كلها تُضاف بزرٍّ وتُحفَظ عندك. فلا يبقى محلٌّ خارج الأداة لأن اسمه لم يرد في قائمة.' },
  ...
  { view: 'data', sel: '#btn-fetch-reviews', title: 'الطريق الأسرع: جلبٌ تلقائي',
    body: 'بضغطةٍ تأتي كل التعليقات بتقييماتها من الرابط. يحتاج مفتاح مزوّد في بيئة Netlify.' },
  { view: 'data', sel: '#d-reviews', title: 'أو ألصقها بيدك',
    body: 'انسخ من صفحة قوقل كما هي؛ يُتعرَّف على التواريخ وردود المالك ويُتجاهَل الزائد. والنجوم لا تُنسَخ لأن قوقل يرسمها صورةً — فيبقى التقييم فارغًا ولا يُخمَّن.' },
  ...
  { view: 'data', sel: '#integrity-box', title: 'أمانة النقل',
    body: 'شرط هذه الأداة: لا يُعدَّل تعليق ولا تقييم ولو كان ذمًّا. وهنا يُقارَن نصّ كل تعليق بمصدرك حرفًا بحرف، ويُقَرّ في التقرير بما استُبعد إن استُبعد.' },
  { view: 'data', sel: '#anomaly-box', title: 'فحص سلامة العيّنة',
    body: 'إشارات على تعليقات قد تكون مفتعلة. لا يُحذف شيء إلا بأمرك.' },
  { view: 'pipeline', sel: '#btn-run-all', title: 'ثماني خطوات — بزرٍّ واحد',
    body: 'بمفتاح OpenRouter تُشغَّل الثماني آليًّا وترى النموذج يكتب أمامك. وبلا مفتاح: انسخ الرسالة وألصق الإجابة. ومدقّق السند يفحص كل خطوة، ويرفض ما اخترع معرّفًا.' },
