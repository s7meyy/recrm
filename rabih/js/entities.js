...
صباحا مساء ظهرا ليلا يوم يومين اليوم امس البارحه الاسبوع الشهر السنه
ساعه ساعتين دقيقه دقايق وقت اوقات فتره مده طويل طويله قصير قصيره
عمل العمل شغل الشغل دوام رد ردوا يرد ترد اهتم يهتم اعتذر يعتذر
طلب طلبي الطلب طلبيه شخص اشخاص ناس الناس احد واحد اثنين
جميل حلو ممتاز رائع سيء زفت نظيف وسخ سريع بطيء غالي رخيص
...
/**
 * عباراتٌ من كلمتين فأكثر — **ولا تُقبَل الكلمة المجرّدة**.
 *
 * كان المستخرِج يقبل كل كلمةٍ ليست وظيفية، فأخرج «مساء» و«صباحا» و«طويل»
 * بوصفها «أصنافًا متكررة» — وقسمٌ يَعِد بأصناف ويُسلّم ظروف زمان يُسقط ثقة
 * العميل بما حوله كلّه. فصار الكيان يلزمه إمّا قرينةٌ تدلّ عليه («طلبت
 * اللاتيه»، «الموظف فهد») وإمّا عبارةٌ مركّبة تتكرّر.
 */
function phrases(tokens) {
  ...
  for (let i = 0; i < tokens.length - 1; i += 1) {
    ...
    if (usable(w) && usable(next)) out.push(`${w} ${next}`);
  }
  return out;
}
