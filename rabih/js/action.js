...
export function nextBlock(place, job = {}) {
  ...
  return `<section class="next">
    ...
    <div class="next-grid">
      ...
      <div>
        <b>وكيف تعرف أنّ هذا نفع؟</b>
        <p>لا نطلب منك تصديقنا. المؤشّرُ مكتوبٌ بجانب كل مهمّة في خطة العمل،
        وفي التقرير القادم يُقاس <b>بالنصيب من العيّنة لا بالعدد المجرّد</b>،
        ويُقال فيه ما تحسّن وما تراجع وما لم يُحسَم — ولو لم يتغيّر شيء قيل ذلك.
        <br><b>والتحسّن بعد المهمّة اقترانٌ لا برهان</b>: قد يكون لها وقد يكون لغيرها،
        ولا نَنسبه إلينا.</p>
      </div>
      <div>
