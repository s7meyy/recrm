...
const ASSETS = [
  ...
  './js/peak.js', './js/agreement.js', './js/history.js', './js/tour.js', './js/places.js', './js/confidence.js', './js/reviews.js', './js/runner.js', './js/stamp.js', './js/integrity.js',
