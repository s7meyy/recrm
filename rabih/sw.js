...
const ASSETS = [
  ...
  './js/peak.js', './js/agreement.js', './js/history.js', './js/tour.js', './js/places.js', './js/confidence.js', './js/reviews.js', './js/runner.js', './js/stamp.js', './js/integrity.js', './js/priority.js', './js/stars.js', './js/voice.js', './js/impact.js', './js/sources.js', './js/clients.js', './js/cloud.js', './js/share.js',
